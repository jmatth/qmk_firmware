...
enum custom_keycodes {
  ...
  VRSN,
  RGB_SLD,
  RGB_2, RGB_3, RGB_4, RGB_5, RGB_6, RGB_7, RGB_8, RGB_9, RGB_10, RGB_11, RGB_12, RGB_13, RGB_14, RGB_15, RGB_16,
  RGB_17, RGB_18, RGB_19, RGB_20, RGB_21, RGB_22, RGB_23, RGB_24, RGB_25, RGB_26, RGB_27, RGB_28, RGB_29, RGB_30,
  RGB_31, RGB_32, RGB_33, RGB_34,
};
 ...
 *
 * ,--------------------------------------------------.           ,--------------------------------------------------.
 * |   =    |   1  |   2  |   3  |   4  |   5  |Adjust|           |Raise |   6  |   7  |   8  |   9  |   0  |   -    |
 * |--------+------+------+------+------+-------------|           |------+------+------+------+------+------+--------|
 * | Tab    |   Q  |   W  |   E  |   R  |   T  |Lower |           | Lower|   Y  |   U  |   I  |   O  |   P  |   \    |
 * |--------+------+------+------+------+------|      |           |      |------+------+------+------+------+--------|
 * |Ctrl/Esc|   A  |   S  |   D  |   F  |   G  |------|           |------|   H  |   J  |   K  |   L  |   ;  |' / Ctrl|
 * |--------+------+------+------+------+------|  [   |           |   ]  |------+------+------+------+------+--------|
 * |LShft/( | Gui/Z| Alt/X|   C  |   V  |   B  |      |           |      |   N  |   M  |   ,  |Alt/. |Gui// | RShft/)|
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
...
[_QWERTY] = KEYMAP(  // layer 0 : default
        // left hand
        KC_EQL,         KC_1,      KC_2,        KC_3,    KC_4,   KC_5,   TG(_ADJUST),
        KC_TAB,         KC_Q,      KC_W,        KC_E,    KC_R,   KC_T,   TG(_LOWER),
        CTL_T(KC_ESC),  KC_A,      KC_S,        KC_D,    KC_F,   KC_G,
        KC_LSPO,        GUIZ,      ALTX,        KC_C,    KC_V,   KC_B,   KC_LBRC,
        MO(_LOWER),     MO(_RAISE),KC_LGUI,     KC_LEFT, KC_RGHT,
                                                                   KC_BSPC,   KC_TAB,
                                                                              KC_HOME,
                                                             KC_BSPC, KC_TAB, KC_END,
        // right hand
             TG(_RAISE),  KC_6,   KC_7,   KC_8,      KC_9,     KC_0,               KC_MINS,
             TG(_LOWER),  KC_Y,   KC_U,   KC_I,      KC_O,     KC_P,               KC_BSLS,
                          KC_H,   KC_J,   KC_K,      KC_L,     KC_SCLN,            CTL_T(KC_QUOT),
             KC_RBRC,     KC_N,   KC_M,   KC_COMM,   ALTDOT,   GUISLSH,            KC_RSPC,
 ...
 *
 * ,--------------------------------------------------.           ,--------------------------------------------------.
 * |        |  F1  |  F2  |  F3  |  F4  |  F5  |      |           |RGB_SD| RGB1 | RGB2 |      |      |      |        |
 * |--------+------+------+------+------+-------------|           |------+------+------+------+------+------+--------|
 * |        |   #  |   @  |   {  |   }  |   |  |      |           |      |      |      |      |      |      |        |
 * |--------+------+------+------+------+------|      |           |      |------+------+------+------+------+--------|
 * |        |   !  |   $  |   (  |   )  |   =  |------|           |------|      |      |      |      |      |        |
...
[_ADJUST] = KEYMAP(
       ...
       VRSN,    KC_HASH, KC_AT,   KC_LCBR, KC_RCBR, KC_PIPE, _______,
       COLEMAK, KC_EXLM, KC_DLR,  KC_LPRN, KC_RPRN, KC_EQL,
       QWERTY,  KC_PERC, KC_CIRC, KC_LBRC, KC_RBRC, KC_TILD, _______,
       _______, _______, _______, _______, _______,
                                                    _______, _______,
                                                             _______,
                                           _______, _______, _______,
       // right hand
       RGB_SLD, RGB_2,  RGB_3,  RGB_4,  RGB_5,   _______, _______,
       _______, RGB_6,  RGB_7,  RGB_8,  _______, _______, _______,
                RGB_9,  RGB_10, RGB_11, RGB_12,  RGB_13,  RGB_14,
       _______, RGB_15, RGB_16, RGB_17, RGB_18,  RGB_19,  RGB_20,
                        RGB_21, RGB_22, RGB_23,  RGB_24,  RGB_25,
       RGB_TOG, RGB_SLD,
       _______,
